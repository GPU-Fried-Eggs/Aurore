        ...
        public void OnUpdate(ref SystemState state)
        {
            foreach 
                (var (characterAnimation, characterBody, characterTransform, characterData,
                     characterStateMachine, characterInitialized, characterControl, entity) in SystemAPI
                     .Query<
                     ...
                     .WithEntityAccess())
            {
                var animatorParamsAspect = SystemAPI.GetAspect<AnimatorParametersAspect>(characterInitialized.Reference);
                var animatorTransform = SystemAPI.GetComponentRW<LocalTransform>(characterInitialized.Reference);
