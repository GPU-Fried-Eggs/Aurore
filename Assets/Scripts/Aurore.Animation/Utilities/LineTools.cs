...
public static class LineTools
{
	...
	private static float3 CalculateBoundingCircle(float2 p0, float2 p1, float2 p2)
	{
		var pc1 = (p1 + p0) * 0.5f;
		var pc2 = (p1 + p2) * 0.5f;
		...
		var sincosHalfPi = new float2(1, 0);
	...
	private static float4 BezierGetAc(float2 p0, float2 p1, float2 p2, float t)
	{
		var t2 = t * t;
		var t3 = t2 * t;
		var oneMinusT = 1 - t;
