#ifndef UNIVERSAL_BONE_RENDERER_INCLUDED
#define UNIVERSAL_BONE_RENDERER_INCLUDED
...
Varyings ForwardPassVertex(Attributes i)
{
    ...
    switch (i.vertexID)
    {
    case 0: worldPos = bd.pos0;
        break;
    case 5: worldPos = bd.pos1;
        break;
    default:
        {
...
float4 ForwardPassFragment(Varyings i): SV_Target0
{
    return i.color;
}
