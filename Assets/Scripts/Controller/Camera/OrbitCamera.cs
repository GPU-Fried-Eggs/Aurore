...
namespace Camera
{
    ...
    public struct OrbitCamera : IComponentData
    {
        ...
        [HideInInspector] public float CurrentDistanceFromMovement;
        [HideInInspector] public float CurrentDistanceFromObstruction;
        [HideInInspector] public float PitchAngle;
        [HideInInspector] public float3 PlanarForward;

        [HideInInspector] public Entity ActiveCameraTarget;
        [HideInInspector] public Entity PreviousCameraTarget;
        [HideInInspector] public float CameraTargetTransitionStartTime;
        [HideInInspector] public RigidTransform CameraTargetTransform;
        [HideInInspector] public RigidTransform CameraTargetTransitionFromTransform;
        [HideInInspector] public bool PreviousCalculateUpFromGravity;
