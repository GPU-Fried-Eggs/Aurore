...
using Unity.Physics;
using Utilities;
using KinematicCharacterAspect = Character.Kinematic.KinematicCharacterAspect;
...
namespace Character
{
    ...
    public readonly partial struct CharacterAspect : IAspect, IKinematicCharacterProcessor<CharacterUpdateContext>
    {
        ...
        public unsafe bool CanStandUp(ref CharacterUpdateContext context, ref KinematicCharacterUpdateContext baseContext)
        {
            ...
            var isObstructed = KinematicAspect.CalculateDistanceClosestCollisions(in this,
                ref context,
                ref baseContext,
                characterPosition,
                characterRotation,
        ...
        {
            return currentCharacterState is CharacterState.GroundMove or CharacterState.AirMove;
        }
