            ...
            in CharacterAspect aspect)
        {
            ...
            if (characterBody.IsGrounded)
            {
                ...
                // Move on ground
                {
                    ...
                    var projectVector = math.normalizesafe(MathUtilities.ProjectOnPlane(characterControl.MoveVector, characterBody.GroundingUp));
                    var moveVectorOnPlane = projectVector * math.length(characterControl.MoveVector);
                    var targetVelocity = moveVectorOnPlane * chosenMaxSpeed;
                    CharacterControlUtilities.StandardGroundMoveInterpolated(ref characterBody.RelativeVelocity,
                        targetVelocity,
                        chosenSharpness,
                        deltaTime,
