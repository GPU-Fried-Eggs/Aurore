...
namespace Character.States
{
    public struct SwimmingState : ICharacterState
    {
            ...
            in CharacterAspect aspect)
        {
            ...
            ref var characterProperties = ref aspect.KinematicAspect.CharacterData.ValueRW;
            ...
            in CharacterAspect aspect)
        {
                    ...
                    out character.DistanceFromWaterSurface))
            {
                ...
                if (character.DistanceFromWaterSurface > character.SwimmingStandUpDistanceFromSurface)
                {
                    ...
                    var dotMoveDirectionWithSurface = math.dot(math.normalizesafe(characterControl.MoveVector), character.DirectionToWaterSurface);
