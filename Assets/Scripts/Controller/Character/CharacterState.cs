...
namespace Character
{
    ...
    {
        /// <summary>
        /// Invoked when transitioning into this state from another. This method is responsible for initializing or
        /// setting up the state upon entry
        /// </summary>
        ...
        /// <summary>
        /// Called when the character is transitioning out of the current state. This method handles any cleanup or
        /// finalization before leaving the state
        /// </summary>
        ...
        /// <summary>
        /// Executed regularly to perform physics-based updates while the character is in this state. This typically
        /// includes applying forces, handling collisions, and other physics-related logic
        /// </summary>
        /// <param name="context"> A reference to the current update context </param>
        /// <param name="baseContext"> A reference to the kinematic update context </param>
        /// <param name="aspect"></param>
        ...
        /// <summary>
        /// Called to handle non-physics updates such as changing internal state variables, handling animations, or
        /// other logic that does not involve physics
        /// </summary>
        /// <param name="context"> A reference to the current update context </param>
        /// <param name="baseContext"> A reference to the kinematic update context </param>
        /// <param name="aspect"></param>
