...
namespace Controller.Character.Kinematic
{
    public readonly partial struct KinematicCharacterAspect
    {
        ...
        public void InitializeUpdate<T, C>(
            in T processor,
            ref C context,
        ...
        /// <typeparam name="T"> The type of the struct implementing <see cref="IKinematicCharacterProcessor{C}"/> </typeparam>
        /// <typeparam name="C"> The type of the user-created context struct </typeparam>
        public void ParentMovementUpdate<T, C>(
            in T processor,
            ref C context,
            ref KinematicCharacterUpdateContext baseContext,
            ref KinematicCharacterBody characterBody,
            ...
            where C : unmanaged
        {
            ...
            if (characterBody.ParentEntity != Entity.Null)
            {
                    ...
                    math.lengthsq(displacementFromParentMovement) > math.EPSILON)
                {
                    ...
                    var castInput = new ColliderCastInput(characterPhysicsCollider.Value, characterPosition, characterPosition + (castDirection * castLength), characterRotation);
        ...
        /// <typeparam name="T"> The type of the struct implementing <see cref="IKinematicCharacterProcessor{C}"/> </typeparam>
        /// <typeparam name="C"> The type of the user-created context struct </typeparam>
        public void GroundingUpdate<T, C>(
            in T processor,
            ref C context,
            ref KinematicCharacterUpdateContext baseContext,
            ref KinematicCharacterBody characterBody,
            ...
            where C : unmanaged
        {
            ...
            if (characterData.EvaluateGrounding)
            {
                ...
                if (newIsGrounded)
                {
                    var groundCharacterHit = KinematicCharacterUtilities.CreateCharacterHit(
                        in newGroundHit,
        ...
        /// <typeparam name="T"> The type of the struct implementing <see cref="IKinematicCharacterProcessor{C}"/> </typeparam>
        /// <typeparam name="C"> The type of the user-created context struct </typeparam>
        public void MovementAndDecollisionsUpdate<T, C>(
            in T processor,
            ref C context,
            ref KinematicCharacterUpdateContext baseContext,
            ref KinematicCharacterBody characterBody,
        ...
        /// <typeparam name="T"> The type of the struct implementing <see cref="IKinematicCharacterProcessor{C}"/> </typeparam>
        /// <typeparam name="C"> The type of the user-created context struct </typeparam>
        public void PreventGroundingFromFutureSlopeChangeUpdate<T, C>(
            in T processor,
            ref C context,
            ref KinematicCharacterUpdateContext baseContext,
            ref KinematicCharacterBody characterBody,
        ...
        /// <typeparam name="T"> The type of the struct implementing <see cref="IKinematicCharacterProcessor{C}"/> </typeparam>
        /// <typeparam name="C"> The type of the user-created context struct </typeparam>
        public void GroundPushingUpdate<T, C>(
            in T processor,
            ref C context,
            ref KinematicCharacterUpdateContext baseContext,
            float3 gravity,
            ...
            where C : unmanaged
        {
            ...
            if (characterBody.IsGrounded && characterData.SimulateDynamicBody)
            {
                    ...
                    PhysicsUtilities.IsBodyDynamic(in baseContext.PhysicsWorld, characterBody.GroundHit.RigidBodyIndex))
                {
                    ...
                    var groundPointVelocity = groundPhysicsVelocity.GetLinearVelocity(
                        groundPhysicsMass,
        ...
        public void ProcessStatefulCharacterHitsUpdate()
        {
            ...
            foreach (var characterHit in CharacterHitsBuffer)
            {
                ...
                var entityWasInStatefulHitsBefore = OldStatefulHitsContainEntity(in StatefulHitsBuffer, characterHit.Entity, lastIndexOfOldStatefulHits, out var oldHitState);
